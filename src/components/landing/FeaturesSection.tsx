    ...
    <section id="features" className="bg-background py-20 sm:py-28">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <span className="inline-block text-primary font-semibold text-sm uppercase tracking-wider mb-4">Features</span>
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4">
            Everything You Need to Manage Your Workforce
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            From time tracking to payroll, we've got every aspect of HR management covered.
          </p>
        </div>
